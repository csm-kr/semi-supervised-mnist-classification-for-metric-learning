...
class EmbeddingNet(nn.Module):
    def __init__(self):
        ...
        self.convnet = nn.Sequential(nn.Conv2d(1, 16, 3, padding=1),  # 28
                                     ...
                                     nn.Conv2d(128, 128, 3, padding=1),  # 3
                                     nn.ReLU(inplace=True),
                                     nn.BatchNorm2d(128),
                                     )

        self.fc = nn.Sequential(nn.Linear(128 * 7 * 7, 128),
                                nn.ReLU(inplace=True),
                                nn.Linear(128, 10),
                                )
